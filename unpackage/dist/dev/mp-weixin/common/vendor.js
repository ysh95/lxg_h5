...
/***/ 12:
/*!********************************************!*\
  !*** D:/workspan/lxg_h5/static/js/base.js ***!
  \********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {var _regenerator = _interopRequireDefault(__webpack_require__(/*! ./node_modules/@babel/runtime/regenerator */ 13));var _api = _interopRequireDefault(__webpack_require__(/*! ./api.js */ 16));
  ...
  function Base() {var _this = this;_classCallCheck(this, Base);_defineProperty(this, "queryBalance",
    ...
    function (url, name) {
      ...
      return null;
                ...
                if (!e.hideLoading) {e.timer = setTimeout(function () {uni.showLoading({ title: e.loadingText || '加载中' });clearTimeout(t.timer);}, 800);}return _context.abrupt("return", uni.request({ url: e.url, data: Object.assign({// msg_id: store.state.user.id
                  }, e.data), header: e.header || { 'content-type': 'application/x-www-form-urlencoded', Authorization: 'bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJodHRwOlwvXC93d3cubHhnLmNjXC9hcGlcL2F1dGhcL2xvZ2luIiwiaWF0IjoxNTkwMDQ3NjgyLCJleHAiOjE1OTAyNjM2ODIsIm5iZiI6MTU5MDA0NzY4MiwianRpIjoiZlU3RmVSNUdGN0hJd2VDRSIsInN1YiI6MSwicHJ2IjoiMjNiZDVjODk0OWY2MDBhZGIzOWU3MDFjNDAwODcyZGI3YTU5NzZmNyJ9.L3kOAqFDhZ_h7o4drTFduaPjb3HIYP7HR41hvgNJaiE' }, method: e.type || "POST", dataType: e.dataType || "json", responseType: e.responseType || "text" }).then(function (data) {uni.hideLoading();clearTimeout(e.timer);var _data = _slicedToArray(data, 2),err = _data[0],res = _data[1]; // 500 登录过期自动调用login传入上次请求参数重新登录
                  return res.data.status_code == 500 ? _this2.login(e) : res.data;}));case 3:case "end":return _context.stop();}}}, _callee, this);}));function ajax(_x) {return _ajax.apply(this, arguments);}return ajax;}() }, { key: "login", value: function () {var _login = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2(e, p_id) {var _ref, _ref2, err, res, userInfo, loginData, data;return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:_context2.next = 2;return uni.login();case 2:_ref = _context2.sent;_ref2 = _slicedToArray(_ref, 2);err = _ref2[0];res = _ref2[1];userInfo = _index.default.state.userInfo;loginData = { code: res.code, name: userInfo.nickName, pic: userInfo.avatarUrl };_context2.next = 10;return this.ajax({ url: _api.default.login, data: loginData });case 10:data = _context2.sent;if (!(data.error_code == 4000)) {_context2.next = 17;break;}_index.default.commit('setUser', data.data); // 判断是否属于登录过期重新登录，e存在则重新上次请求
...
function padZero(num, targetLength) {return num.toString().length == 1 ? '0' + num : num;
}
...
/***/ 16:
/*!*******************************************!*\
  !*** D:/workspan/lxg_h5/static/js/api.js ***!
  \*******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 17:
/*!*****************************************!*\
  !*** D:/workspan/lxg_h5/store/index.js ***!
  \*****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 23:
/*!*********************************************************************!*\
  !*** D:/workspan/lxg_h5/components/mescroll-uni/mescroll-mixins.js ***!
  \*********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 277:
/*!******************************************************************!*\
  !*** D:/workspan/lxg_h5/components/mescroll-uni/mescroll-uni.js ***!
  \******************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 278:
/*!*************************************************************************!*\
  !*** D:/workspan/lxg_h5/components/mescroll-uni/mescroll-uni-option.js ***!
  \*************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 7:
/*!******************************************************!*\
  !*** D:/workspan/lxg_h5/pages.json?{"type":"style"} ***!
  \******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "pages": { "pages/index/index": { "navigationBarTitleText": "uni-app" }, "pages/indexRecruit/indexRecruit": { "navigationBarTitleText": "招聘/兼职" }, "pages/makeFriends/makeFriends": { "navigationBarTitleText": "相亲/交友" }, "pages/meSkill/meSkill": { "navigationBarTitleText": "我有技能" }, "pages/supplier/supplier": { "navigationBarTitleText": "找供货商" }, "pages/investor/investor": { "navigationBarTitleText": "找投资人" }, "pages/borrower/borrower": { "navigationBarTitleText": "找借款人" }, "pages/wantDetail/wantDetail": { "navigationBarTitleText": "求购详情" }, "pages/postWant/postWant": { "navigationBarTitleText": "发布求购信息" }, "pages/postRecruit/postRecruit": { "navigationBarTitleText": "发布招聘信息" }, "pages/postJob/postJob": { "navigationBarTitleText": "发布求职信息" }, "pages/postPersonal/postPersonal": { "navigationBarTitleText": "发布个人信息" }, "pages/postCompany/postCompany": { "navigationBarTitleText": "发布公司信息" }, "pages/posTinvestor/posTinvestor": { "navigationBarTitleText": "发布投资人" }, "pages/postStock/postStock": { "navigationBarTitleText": "发布股权/投资" }, "pages/postMakeFri/postMakeFri": { "navigationBarTitleText": "发布相亲/交友信息" }, "pages/postSupplier/postSupplier": { "navigationBarTitleText": "发布供货商" }, "pages/postLoan/postLoan": { "navigationBarTitleText": "发布借款人" }, "pages/postProject/postProject": { "navigationBarTitleText": "发布项目" }, "pages/supplierDetail/supplierDetail": { "navigationBarTitleText": "供货商详情" }, "pages/jobDetail/jobDetail": { "navigationBarTitleText": "求职详情" }, "pages/investorDetail/investorDetail": { "navigationBarTitleText": "投资人详情" }, "pages/companyDetailSkill/companyDetailSkill": { "navigationBarTitleText": "公司详情" }, "pages/personalDetailSkill/personalDetailSkill": { "navigationBarTitleText": "个人详情" }, "pages/borrowerDetail/borrowerDetail": { "navigationBarTitleText": "借款详情" }, "pages/stock/stock": { "navigationBarTitleText": "找股权投资" }, "pages/stockDetail/stockDetail": { "navigationBarTitleText": "股权/投资详情" }, "pages/goodProject/goodProject": { "navigationBarTitleText": "好项目招商加盟" }, "pages/goodProjectDetail/goodProjectDetail": { "navigationBarTitleText": "好项目详情" }, "pages/makeFriDetail/makeFriDetail": { "navigationBarTitleText": "个人信息" }, "pages/recruitDetail/recruitDetail": { "navigationBarTitleText": "招聘详情" } }, "globalStyle": { "navigationBarTextStyle": "black", "navigationBarTitleText": "uni-app", "navigationBarBackgroundColor": "#F8F8F8", "backgroundColor": "#F8F8F8" } };exports.default = _default;

/***/ }),

/***/ 8:
/*!*****************************************************!*\
  !*** D:/workspan/lxg_h5/pages.json?{"type":"stat"} ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
